...
const CustomFooterModal = ({ show, setShow }) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        dialogClassName="modal-90w custom-footer-modal"
        aria-labelledby="example-custom-modal-styling-title"
      >
        <Modal.Header closeButton>
          <Modal.Title id="example-custom-modal-styling-title">
            <svg className="mt-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 14" id="linkedin-logo-blue-xxsmall" aria-hidden="true" role="none" data-supported-dps="56x14" width="80">
              <g>
