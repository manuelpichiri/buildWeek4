...
import { customFooterLinks } from "../customFooter/CustomFooterData"
import './style.css'
import CustomFooterModal from "./customFooterModal/CustomFooterModal";

const ReducedCustomFooter = () => {
  ...
  return (
    ...
    <>
      <footer
        className="reduced-footer-main-container"
      >
        <div
          className="d-flex gap-3"
        >
          <ul
            className="reduced-custom-footer-links-list list-unstyled"
          >

            {customFooterLinks.slice(0, 8).map((link, index) => (
...
export default ReducedCustomFooter