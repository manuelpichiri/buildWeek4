import { ThumbsUp, MessageSquareText, Repeat2, Send, Plus, Ellipsis } from "lucide-react"
...
const CustomPost = ({
  ...
  return (
    ...
    <div
      className="custom-post-main-container"
    >
      ...
      <div className="custom-post-header">
        <div className="custom-post-header-author">
          ...
          <div className="custom-post-header-author-description">
            ...
            {authorFollowersNum ? <p className="m-0">{authorFollowersNum} follower</p> : (
              <p className="m-0">{authorJobTitle}</p>
            )}
            {isSponsored ? (<p className="m-0">Post sponsorizzato</p>) : (
              <div
      ...
      <Linkify
        options={{ className: 'custom-post-caption-link' }}
      >
        <p
          className="custom-post-caption"
        >{caption}</p>
      </Linkify>
      <img
      ...
      <div
        className="custom-post-footer mt-4"
      >
        <div>
          <ThumbsUp
            size={16}
