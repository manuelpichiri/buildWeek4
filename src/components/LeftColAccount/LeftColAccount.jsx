  ...
  return (
    <>
      <Container fluid>
          ...
          <Col className="reset-padding">
            <div className="bg-light mt-2 mb-2 border-general-div ">
              ...
              <div className="div-account-img">
                <a href="#">
                  <img className="account-img" src="/assets/images.png" />
                </a>
              </div>
              <div className="mt-5 ms-3 d-flex flex-column ">
                <a className="link-custom" href="#">
                  <h3 className="m-0">Massimo Rossi</h3>
        ...
        <Row>
          <Col className="reset-padding">
            <div className="d-flex flex-column bg-light border-general-div premium-div mb-2">
              <a className="link-connect flex-column  ">
                ...
                <div className="d-flex align-items-center">
                  <p className="paragraph-custom-study icon-p-premium m-0 ">
                    <img className="premium-img" src="/assets/premium.png" />
        ...
        <Row>
          <Col className="reset-padding">
            <div className="bg-light border-general-div p-2 mb-2 ">
              <div>
                <ul className="list-of-element p-0 ms-1">
                  ...
                  <li className="line">
                    <a href="#">
                      <Users fill="#000000d6" size={17} className="icon-list" />
                      Gruppi
                    </a>
                  </li>
                  <li className="line">
